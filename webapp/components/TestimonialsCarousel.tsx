...
const tweets: Tweet[] = [
  ...
  },
  {
    ...
    author: "jake",
    username: "Jakegallen",
    content: "This migration chart app by @Luke_Halley_ is so sickkk.\n\nSomething something migrations are bullish 🫡",
    verified: false,
  ...
  },
  {
    ...
    content: "@Luke_Halley_ from @PayAINetwork community built it for free",
    verified: false,
