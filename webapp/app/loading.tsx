...
export default function RootLoading() {
  return (
    <div className="landing-loading">
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Syne:wght@700&family=JetBrains+Mono:wght@600&display=swap');
        ...
        @keyframes pulse-glow {
          0%, 100% {
            filter: drop-shadow(0 0 8px rgba(82, 201, 125, 0.6)) drop-shadow(0 0 4px rgba(82, 201, 125, 0.4));
          }
          50% {
            filter: drop-shadow(0 0 16px rgba(82, 201, 125, 0.8)) drop-shadow(0 0 8px rgba(82, 201, 125, 0.6));
          }
        }
